 ...
 * @author Nestors
 */
public class tipoDeProblemas extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Tipos de problemas");
    ...
    private void btnAgregarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnAgregarActionPerformed
        ...
        txtCodigo.setText(Metodos.ultimoCodigo("id_tipo_problema", "tipos_de_problemas"));
    ...
    private void btnGrabarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnGrabarActionPerformed
        int respuesta = 5;
        duplicado = Metodos.evitarDuplicado("tipos_de_problemas", "tipo_proble_descri", txtNombre.getText().trim(), "id_tipo_problema", txtCodigo.getText());
        ...
        if (respuesta==0) {
            ...
            if(operacion.equals("agregar")){
                sql="Insert into tipos_de_problemas (tipo_proble_descri) "
                + "values ('"+txtNombre.getText().toUpperCase().trim()+"')";
            }
            
            if(operacion.equals("modificar")){
                sql="update tipos_de_problemas set tipo_proble_descri = '"+txtNombre.getText().toUpperCase().trim()+"'  where id_tipo_problema = "+txtCodigo.getText();
            }
            
            if(operacion.equals("borrar")){
                sql="Delete from tipos_de_problemas where id_tipo_problema = "+txtCodigo.getText();
            }
            ...
            try {
                ...
                Logger.getLogger(tipoDeProblemas.class.getName()).log(Level.SEVERE, null, ex);
                JOptionPane.showMessageDialog(null, ex.getMessage());
                
            } catch (SQLException ex) {
                Logger.getLogger(tipoDeProblemas.class.getName()).log(Level.SEVERE, null, ex);
                if(operacion.equals("borrar") && txtCodigo.getText().equals("")){
                    JOptionPane.showMessageDialog(null, "Primero debe seleccionar un tipo de problema");
                }
                if (operacion.equals("borrar") && !txtCodigo.getText().equals("")) {
...
//                JOptionPane.showMessageDialog(null, ex.getMessage());
    ...
    public void getDatos(){
        ...
        try {
            cn.conectar();
            ResultSet provee=cn.consultar("select * from tipos_de_problemas where tipo_proble_descri ilike '%"+txtBuscador.getText()+"%' order by id_tipo_problema"); //order by ordena de menor a mayor, si se quiere de mayor a menor se le agrega desc al final
            Metodos.limpiarTabla(grillaBanco);
            if(provee.isBeforeFirst()){
                while(provee.next()){
                    Metodos.cargarTabla(grillaBanco, new Object[]{provee.getString("id_tipo_problema"), provee.getString("tipo_proble_descri")});
                }
            }else{
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(tipoDeProblemas.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
