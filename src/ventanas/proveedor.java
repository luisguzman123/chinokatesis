...
public class proveedor extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        grillaBanco.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Código", "Nombre", "RUC", "Teléfono", "Email", "Dirección"
            }
        ) {
    ...
    private void btnAgregarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnAgregarActionPerformed
        ...
        txtCodigo.setText(Metodos.siguienteCodigo("pro_id", "proveedor"));
    ...
    private void btnGrabarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnGrabarActionPerformed
        int respuesta = 5;
        duplicado = Metodos.evitarDuplicado("proveedor", "pro_nom", txtNombre.getText().trim(), "pro_id", txtCodigo.getText());
        ...
        if (respuesta==0) {
            ...
            if(operacion.equals("agregar")){
                sql="Insert into proveedor (pro_nom, pro_ruc, pro_tel, email, direccion) "
                + "values ('"+txtNombre.getText().toUpperCase().trim()+"', '"+txtRuc.getText().toUpperCase()+"','"+txtTelef.getText().toUpperCase()+"','"+txtEmail.getText().toUpperCase()+"','"+txtDire.getText().toUpperCase()+"')";
            }
            
            if(operacion.equals("modificar")){
                sql="update proveedor set pro_nom = '"+txtNombre.getText().toUpperCase().trim()+"', pro_ruc = '"+txtRuc.getText().toUpperCase()+"', pro_tel = '"+txtTelef.getText().toUpperCase()+"', email = '"+txtEmail.getText().toUpperCase()+"', direccion = '"+txtDire.getText().toUpperCase()+"'  where pro_id = "+txtCodigo.getText();
            }
            
            if(operacion.equals("borrar")){
                sql="Delete from proveedor where pro_id = "+txtCodigo.getText();
            }
...
//                JOptionPane.showMessageDialog(null, ex.getMessage());
    ...
    private void grillaBancoMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_grillaBancoMouseClicked
       ...
       String ruc= grillaBanco.getValueAt(fila, 2).toString();
       String telef= grillaBanco.getValueAt(fila, 3).toString();
       String email= grillaBanco.getValueAt(fila, 4).toString();
       String direccion= grillaBanco.getValueAt(fila, 5).toString();
       
       if(busqueda.equals("presupuesto_proveedor") && operacion.equals("")){   //primero se realiza esta accion porque de otro modo vacia la variable "operacion"
           presupuesto_de_compra.txtcodProvee.setText(cod);
           presupuesto_de_compra.txtProvee.setText(nombre);
           presupuesto_de_compra.txtProvee.requestFocus();
           busqueda = "";
           dispose();
       }
    ...
    private void btnReporteActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnReporteActionPerformed
        vehiculos.reporteImprimir("reporteProveedor.jasper");
    ...
    public void getDatos(){
        ...
        try {
            cn.conectar();
            ResultSet provee=cn.consultar("select * from proveedor where pro_nom ilike '%"+txtBuscador.getText()+"%' order by pro_id"); //order by ordena de menor a mayor, si se quiere de mayor a menor se le agrega desc al final
            Metodos.limpiarTabla(grillaBanco);
            if(provee.isBeforeFirst()){
                while(provee.next()){
                    Metodos.cargarTabla(grillaBanco, new Object[]{provee.getString("pro_id"), provee.getString("pro_nom"), provee.getString("pro_ruc"), provee.getString("pro_tel"), provee.getString("email"), provee.getString("direccion")});
                }
            }else{
