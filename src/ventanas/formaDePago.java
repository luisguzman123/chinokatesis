...
public class formaDePago extends javax.swing.JFrame {
    ...
    private void btnAgregarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnAgregarActionPerformed
        ...
        txtCodigo.setText(Metodos.siguienteCodigo("for_pago_id", "forma_pago"));
    ...
    private void btnGrabarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnGrabarActionPerformed
        int respuesta = 5;
        duplicado = Metodos.evitarDuplicado("forma_pago", "for_pago_descri", txtNombre.getText().trim(), "for_pago_id", txtCodigo.getText());
        ...
        if (respuesta==0) {
            ...
            if(operacion.equals("agregar")){
                sql="Insert into forma_pago (for_pago_id, for_pago_descri) "
                + "values ("+txtCodigo.getText()+", '"+txtNombre.getText().toUpperCase().trim()+"')";
            }
            
            if(operacion.equals("modificar")){
                sql="update forma_pago set for_pago_descri = '"+txtNombre.getText().toUpperCase().trim()+"'  where for_pago_id = "+txtCodigo.getText();
            }
            
            if(operacion.equals("borrar")){
                sql="Delete from forma_pago where for_pago_id = "+txtCodigo.getText();
            }
            ...
            try {
                ...
                if(operacion.equals("borrar") && txtCodigo.getText().equals("")){
                    JOptionPane.showMessageDialog(null, "Primero debe seleccionar una forma de pago");
                }
                if (operacion.equals("borrar") && !txtCodigo.getText().equals("")) {
...
//       }
    ...
    private void btnReporteActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnReporteActionPerformed
       vehiculos.reporteImprimir("reporteFormaPago.jasper");
    ...
    public void getDatos(){
        ...
        try {
            cn.conectar();
            ResultSet provee=cn.consultar("select * from forma_pago where for_pago_descri ilike '%"+txtBuscador.getText()+"%' order by for_pago_id"); //order by ordena de menor a mayor, si se quiere de mayor a menor se le agrega desc al final
            Metodos.limpiarTabla(grillaBanco);
            if(provee.isBeforeFirst()){
                while(provee.next()){
                    Metodos.cargarTabla(grillaBanco, new Object[]{provee.getString("for_pago_id"), provee.getString("for_pago_descri")});
                }
            }else{
