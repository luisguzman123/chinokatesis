...
public class ciudad extends javax.swing.JFrame {
    ...
    private void btnAgregarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnAgregarActionPerformed
        ...
        txtCodigo.setText(Metodos.ultimoCodigo("ciu_id", "ciudad"));
    ...
    private void btnGrabarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnGrabarActionPerformed
        int respuesta = 5;
        duplicado = Metodos.evitarDuplicado("ciudad", "ciu_nom", txtNombre.getText().trim(), "ciu_id", txtCodigo.getText());
        ...
        if (respuesta==0) {
            ...
            if(operacion.equals("agregar")){
                sql="Insert into ciudad (ciu_nom) "
                + "values ('"+txtNombre.getText().toUpperCase().trim()+"')";
            }
            
            if(operacion.equals("modificar")){
                sql="update ciudad set ciu_nom = '"+txtNombre.getText().toUpperCase().trim()+"'  where ciu_id = "+txtCodigo.getText();
            }
            
            if(operacion.equals("borrar")){
                sql="Delete from ciudad where ciu_id = "+txtCodigo.getText();
            }
            ...
            try {
                ...
                if(operacion.equals("borrar") && txtCodigo.getText().equals("")){
                    JOptionPane.showMessageDialog(null, "Primero debe seleccionar una Ciudad");
                }
                if (operacion.equals("borrar") && !txtCodigo.getText().equals("")) {
...
//       }
    ...
    public void getDatos(){
        ...
        try {
            cn.conectar();
            ResultSet provee=cn.consultar("select * from ciudad where ciu_nom ilike '%"+txtBuscador.getText()+"%' order by ciu_id"); //order by ordena de menor a mayor, si se quiere de mayor a menor se le agrega desc al final
            Metodos.limpiarTabla(grillaBanco);
            if(provee.isBeforeFirst()){
                while(provee.next()){
                    Metodos.cargarTabla(grillaBanco, new Object[]{provee.getString("ciu_id"), provee.getString("ciu_nom")});
                }
            }else{
