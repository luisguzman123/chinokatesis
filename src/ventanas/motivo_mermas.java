 ...
 * @author Nestors
 */
public class motivo_mermas extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Motivo de Mermas");
    ...
    private void btnAgregarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnAgregarActionPerformed
        ...
        txtCodigo.setText(Metodos.siguienteCodigo("cod_motivo", "motivo_merma"));
    ...
    private void btnGrabarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnGrabarActionPerformed
        int respuesta = 5;
        duplicado = Metodos.evitarDuplicado("motivo_merma", "moti_desc", txtNombre.getText().trim(), "cod_motivo", txtCodigo.getText());
        ...
        if (respuesta==0) {
            ...
            if(operacion.equals("agregar")){
                sql="Insert into motivo_merma (moti_desc) "
                + "values ('"+txtNombre.getText().toUpperCase().trim()+"')";
            }
            
            if(operacion.equals("modificar")){
                sql="update motivo_merma set moti_desc = '"+txtNombre.getText().toUpperCase().trim()+"'  where cod_motivo = "+txtCodigo.getText();
            }
            
            if(operacion.equals("borrar")){
                sql="Delete from motivo_merma where cod_motivo = "+txtCodigo.getText();
            }
            ...
            try {
                ...
                Logger.getLogger(motivo_mermas.class.getName()).log(Level.SEVERE, null, ex);
                JOptionPane.showMessageDialog(null, ex.getMessage());
                
            } catch (SQLException ex) {
                Logger.getLogger(motivo_mermas.class.getName()).log(Level.SEVERE, null, ex);
                if(operacion.equals("borrar") && txtCodigo.getText().equals("")){
                    JOptionPane.showMessageDialog(null, "Primero debe seleccionar una motivo.");
                }
                if (operacion.equals("borrar") && !txtCodigo.getText().equals("")) {
...
//       }
    ...
    private void btnReporteActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnReporteActionPerformed
        vehiculos.reporteImprimir("reporteMotivoMermas.jasper");
    ...
    public void getDatos(){
        ...
        try {
            cn.conectar();
            ResultSet provee=cn.consultar("select * from motivo_merma where moti_desc ilike '%"+txtBuscador.getText()+"%' order by cod_motivo"); //order by ordena de menor a mayor, si se quiere de mayor a menor se le agrega desc al final
            Metodos.limpiarTabla(grillaBanco);
            if(provee.isBeforeFirst()){
                while(provee.next()){
                    Metodos.cargarTabla(grillaBanco, new Object[]{provee.getString("cod_motivo"), provee.getString("moti_desc")});
                }
            }else{
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(motivo_mermas.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
