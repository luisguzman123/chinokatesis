...
public class busRecepcion extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        grillaBuscador.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Código", "Fecha", "Estado", "Código Empleado", "Empleado", "Código Cliente", "Cliente", "Código Sucursal", "Sucursal"
            }
        ) {
    ...
    private void seleccionarRecepcion() {
        ...
        if (busqueda.equals("recepcion")) {   //primero se realiza esta accion porque de otro modo vacia la variable "operacion"
            recepcion.txtCod.setText(cod);
            recepcion.txtEmpleadoCod.setText(idempleado);
            recepcion.txtEmpleadoDes.setText(empleadoDesc);
            recepcion.txtClienteCod.setText(idcliente);
            recepcion.txtClienteDesc.setText(clienteDesc);
            recepcion.txtCod.requestFocus();
            busqueda = "";
        ...
        try {
            ...
            Logger.getLogger(busRecepcion.class.getName()).log(Level.SEVERE, null, ex);
   ...
   public void getDatos() {
    ...
    private void buscarRecepcion() {
        ...
        try {
            cn.conectar();
            ResultSet recep = cn.consultar("select * from v_recepcion where fecha BETWEEN '" + Metodos.dameFechaFormateadaSQL(DESDE.getDate()) + "' and '"+Metodos.dameFechaFormateadaSQL(HASTA.getDate())+"' and estado !='ANULADO'  order by id_recepcion"); //order by ordena de menor a mayor, si se quiere de mayor a menor se le agrega desc al final
