...
//           pedido_de_compra.txtFecha.setDate(fecha);
   ...
   public void getDatos() {
    ...
    private void buscarPedido() {
        ...
        try {
            cn.conectar();
            ResultSet pedi = cn.consultar("select * from pedido_venta where ped_descrip ilike '%" + txtBuscar.getText() + "%' and estado!='ANULADO' and estado!='UTILIZADO' order by ped_id"); //order by ordena de menor a mayor, si se quiere de mayor a menor se le agrega desc al final
