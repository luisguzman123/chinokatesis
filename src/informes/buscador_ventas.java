...
public class buscador_ventas extends javax.swing.JFrame {

    public buscador_ventas() {
        initComponents();
    ...
    private void initComponents() {
        ...
        jComboBox1.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "Pedido de clientes", "Presupuesto", "Ventas", "Cobranzas", "Apertura-Cierre de caja", "Arqueo de caja", "Recaudaciones a depositar", "Nota de crédito", "Nota de débito", "Nota de remisión" }));
    ...
    private void jbExportarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jbExportarActionPerformed
        if (jrPorFecha.isSelected() && jComboBox1.getSelectedIndex()==3) {
            Metodos.imprimirPorFecha("/src/reportes/reporteVentaPeriodo.jasper", jtDesde.getDate(), jtHasta.getDate());
        }else if (jrCodigo.isSelected() && jComboBox1.getSelectedIndex()==3) {
            Metodos.imprimirPorCodigo("/src/reportes/reporteVentaCodigo.jasper", Integer.parseInt(jtCodigo_desde.getText()), Integer.parseInt(jtCodigo_hasta.getText()));
        }else if (jrEstado.isSelected() && jComboBox1.getSelectedIndex()==3) {
            Metodos.imprimirPorEstado("/src/reportes/reporteVentaEstado.jasper", jcEstado.getSelectedItem().toString());
        }else if (jrPorFecha.isSelected() && jComboBox1.getSelectedIndex()==4) {
            Metodos.imprimirPorFecha("/src/reportes/reporteAperturaCierrePeriodo.jasper", jtDesde.getDate(), jtHasta.getDate());
        }else if (jrCodigo.isSelected() && jComboBox1.getSelectedIndex()==4) {
            Metodos.imprimirPorCodigo("/src/reportes/reporteAperturaCierreCodigo.jasper", Integer.parseInt(jtCodigo_desde.getText()), Integer.parseInt(jtCodigo_hasta.getText()));
        }else if (jrEstado.isSelected() && jComboBox1.getSelectedIndex()==4) {
            Metodos.imprimirPorEstado("/src/reportes/reporteAperturaCierreEstado.jasper", jcEstado.getSelectedItem().toString());
        }
