 ...
 * @author Nestors
 */
public class tipoDeTrabajos extends javax.swing.JFrame {
    ...
    private void btnAgregarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnAgregarActionPerformed
        ...
        txtCodigo.setText(Metodos.ultimoCodigo("id_tipo_trabajo", "tipos_trabajos"));
    ...
    private void btnGrabarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnGrabarActionPerformed
        int respuesta = 5;
        duplicado = Metodos.evitarDuplicado("tipos_trabajos", "descri_tipotrabajo", txtNombre.getText().trim(), "id_tipo_trabajo", txtCodigo.getText());
        ...
        if (respuesta==0) {
            ...
            if(operacion.equals("agregar")){
                sql="Insert into tipos_trabajos (descri_tipotrabajo) "
                + "values ('"+txtNombre.getText().toUpperCase().trim()+"')";
            }
            
            if(operacion.equals("modificar")){
                sql="update tipos_trabajos set descri_tipotrabajo = '"+txtNombre.getText().toUpperCase().trim()+"'  where id_tipo_trabajo = "+txtCodigo.getText();
            }
            
            if(operacion.equals("borrar")){
                sql="Delete from tipos_trabajos where id_tipo_trabajo = "+txtCodigo.getText();
            }
            ...
            try {
                ...
                Logger.getLogger(tipoDeTrabajos.class.getName()).log(Level.SEVERE, null, ex);
                JOptionPane.showMessageDialog(null, ex.getMessage());
                
            } catch (SQLException ex) {
                Logger.getLogger(tipoDeTrabajos.class.getName()).log(Level.SEVERE, null, ex);
                if(operacion.equals("borrar") && txtCodigo.getText().equals("")){
                    JOptionPane.showMessageDialog(null, "Primero debe seleccionar un tipo de trabajo");
                }
                if (operacion.equals("borrar") && !txtCodigo.getText().equals("")) {
...
//                JOptionPane.showMessageDialog(null, ex.getMessage());
    ...
    private void grillaBancoMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_grillaBancoMouseClicked
       ...
       if(busqueda.equals("diagnostico") && operacion.equals("")){   //primero se realiza esta accion porque de otro modo vacia la variable "operacion"
           diagnostico.txtTipoProbleCod.setText(cod);
           diagnostico.txtTipoProbleDesc.setText(nombre);
           diagnostico.txtTipoProbleCod.requestFocus();
           busqueda = "";
           dispose();
       }
       if(busqueda.equals("presupuesto") && operacion.equals("")){   //primero se realiza esta accion porque de otro modo vacia la variable "operacion"
           presupuestoServicios.txtCodTipoTrabajo.setText(cod);
           presupuestoServicios.txtTipoTrabajoDesc.setText(nombre);
           presupuestoServicios.txtCodTipoTrabajo.requestFocus();
           busqueda = "";
           dispose();
       }
       ...
       if(busqueda.equals("descuentos") && operacion.equals("")){   //primero se realiza esta accion porque de otro modo vacia la variable "operacion"
           ...
           descuentos.txtDescriTrabajo.requestFocus();
           busqueda = "";
           dispose();
       }
       if(busqueda.equals("promociones") && operacion.equals("")){   //primero se realiza esta accion porque de otro modo vacia la variable "operacion"
           promociones.txtCodTipoTrabajo.setText(cod);
           promociones.txtDescriTrabajo.setText(nombre);
           promociones.txtDescriTrabajo.requestFocus();
           busqueda = "";
           dispose();
       }
    ...
    public void getDatos(){
        ...
        try {
            cn.conectar();
            ResultSet provee=cn.consultar("select * from tipos_trabajos where descri_tipotrabajo ilike '%"+txtBuscador.getText()+"%' order by id_tipo_trabajo"); //order by ordena de menor a mayor, si se quiere de mayor a menor se le agrega desc al final
            Metodos.limpiarTabla(grillaBanco);
            if(provee.isBeforeFirst()){
                while(provee.next()){
                    Metodos.cargarTabla(grillaBanco, new Object[]{provee.getString("id_tipo_trabajo"), provee.getString("descri_tipotrabajo")});
                }
            }else{
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(tipoDeTrabajos.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
